...
public class ClientesbonecosFindWhereNumeroCcEqualsAction extends Action
{
	/**
	 * Method 'execute'
	 * 
	...
	public ActionForward execute(ActionMapping mapping, ActionForm form, HttpServletRequest request, HttpServletResponse response) throws Exception
	{
		try {
			// parse parameters
			long _numeroCc = Long.parseLong( request.getParameter("numeroCc") );
		
			// create the DAO class
			ClientesbonecosDao dao = ClientesbonecosDaoFactory.create();
		
			// execute the finder
			Clientesbonecos dto[] = dao.findWhereNumeroCcEquals(_numeroCc);
