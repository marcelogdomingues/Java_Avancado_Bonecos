...
public class ClientesbonecosFindWhereNomeEqualsAction extends Action
{
	/**
	 * Method 'execute'
	 * 
	...
	public ActionForward execute(ActionMapping mapping, ActionForm form, HttpServletRequest request, HttpServletResponse response) throws Exception
	{
		try {
			// parse parameters
			java.lang.String _nome = request.getParameter("nome");
		
			// create the DAO class
			ClientesbonecosDao dao = ClientesbonecosDaoFactory.create();
		
			// execute the finder
			Clientesbonecos dto[] = dao.findWhereNomeEquals(_nome);
