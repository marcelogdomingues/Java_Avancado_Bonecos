...
public class ClientesbonecosFindWhereMoradaEqualsAction extends Action
{
	/**
	 * Method 'execute'
	 * 
	...
	public ActionForward execute(ActionMapping mapping, ActionForm form, HttpServletRequest request, HttpServletResponse response) throws Exception
	{
		try {
			// parse parameters
			java.lang.String _morada = request.getParameter("morada");
		
			// create the DAO class
			ClientesbonecosDao dao = ClientesbonecosDaoFactory.create();
		
			// execute the finder
			Clientesbonecos dto[] = dao.findWhereMoradaEquals(_morada);
